                ...
                <Grid container spacing={6}>
                    ...
                    <Grid size={{ xs: 12, lg: 8 }}>
                        ...
                        <Box sx={{ mb: 6 }}>
                            ...
                            >
                                <strong style={{ color: theme.palette.primary.main, fontSize: '1.1em' }}>AniArchive </strong>
                    ...
                    <Grid size={{ xs: 12, lg: 4 }} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' , margin: 'auto' }}>
                        <Paper sx={{ 
                            ...
                            <Box sx={{ mb: 4 }}>
                                {[
                                    { icon: <TrophyIcon />, text: 'Cosplay Competitions', color: theme.palette.primary.main },
                                    { icon: <GroupIcon />, text: 'Artist Alley', color: theme.palette.secondary.main },
                                    { icon: <EventIcon />, text: 'Retro Gaming', color: '#FF9800' },
                                    { icon: <LocationIcon />, text: 'TCG Tournaments', color: theme.palette.info.main }
                                ].map((feature, index) => (
                                    <Box key={index} sx={{ 
                                        display: 'flex', 
                                        alignItems: 'center', 
                            ...
                            <Box sx={{ textAlign: 'center' }}>
                                ...
                                <Box sx={{ 
                                    ...
                                    <FavoriteIcon sx={{ color: theme.palette.primary.main, fontSize: 20 }} />
                                    <FavoriteIcon sx={{ color: theme.palette.secondary.main, fontSize: 20 }} />
                                    <FavoriteIcon sx={{ color: '#FF9800', fontSize: 20 }} />
                                </Box>
                            </Box>
                        </Paper>
                    </Grid>
